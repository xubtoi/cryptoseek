...
# Connect parameters
args = {
    'base_train_task_id': '3fb6a87aa8bd4f2caa59962517dc09db',  # Will be set from pipeline
...
hpo_task = HyperParameterOptimizer(
    ...
    hyper_parameters=[
        UniformIntegerParameterRange('General/epochs', min_value=20, max_value=100, step_size=20),
